...
4. [Crear la imagen y ejecutar el contenedor](../). Ahora {{ site.data.keys.mf_console }} y Analytics Console estarán accesibles solo cuando se cumpla con el mecanismo de seguridad TAI.
