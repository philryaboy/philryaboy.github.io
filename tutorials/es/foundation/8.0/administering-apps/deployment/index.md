...
La API de exportación recupera los artefactos seleccionados para un tiempo de ejecución como un archivo .zip. Utilice la API de despliegue para reutilizar el contenido archivado.
