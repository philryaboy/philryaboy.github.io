...
En la versión actual, Application Center admite aplicaciones creadas para las plataformas Google Android, Apple iOS, Windows Phone 8, Windows 8 y la plataforma Windows 10.
