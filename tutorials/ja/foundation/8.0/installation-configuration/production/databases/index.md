...
以下のサンプルでは、すべてのアプリケーション用の表が、同じユーザーおよびデータベースを対象として作成されます。 ここでは、データベースおよびユーザーが[MySQL のデータベース要件](#database-requirements)に従って作成済みであることを前提としています。
