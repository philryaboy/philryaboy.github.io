...
#### Das Paket `com.worklight.androidgap.api` stellt die Android-Plattformfunktionen für Cordova-Apps bereit. In der {{ site.data.keys.product }} wurden einige Änderungen vorgenommen, um die Cordova-Integration zu ermöglichen. 
